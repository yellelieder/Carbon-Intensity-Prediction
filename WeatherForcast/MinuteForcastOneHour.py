...
def get_url(lat, lng):
    ...
    return f"https://pro.openweathermap.org/data/2.5/onecall?lat={lat}&lon={lng}&exclude=current,hourly,daily,alert&units=metric&appid={WEATHER_DATA_API_KEY}"
...
if __name__=="__main__":
    ...
    print(json.dumps(get_forcast("51.4638242","6.9408401"), indent=1))
